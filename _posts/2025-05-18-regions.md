...
As expected, it appears that **the resulting clusters divide cells along the gradient**.
...
Ultimately, it seems pretty clear by eye that we've identified our ground truth region clusters.
...
Now let's see how well the above analysis generalizes to real tissues, again using [the mouse MOp](https://www.nature.com/articles/s41586-021-03705-x) as an example as in the [last post](/blog/2025/graph-fourier/).
...
<figure style="text-align: center;">
  <img src="/assets/figures/regions/mop/region_clusters.png"
       alt=""
       style="width:100%; display: block; margin: 0 auto;">
  <figcaption><strong>Figure 11:</strong> Region clusters visualized in terms of their gene markers and in tissue space.</figcaption>
</figure>
