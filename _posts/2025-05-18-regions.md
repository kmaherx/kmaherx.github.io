...
<div class="l-page">
  <iframe src="{{ '/assets/plotly/region_gradient.html' | relative_url }}" frameborder='0' scrolling='no' height="500px" width="100%" style="border: 1px dashed grey;"></iframe>
  <figcaption><strong>Figure 2:</strong> Three-dimensional embedding of cells in region space, colored by position along the molecular gradient. </figcaption>
</div>
