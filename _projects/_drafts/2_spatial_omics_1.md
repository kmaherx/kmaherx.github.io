...
description: <em>June 2025</em>
img: assets/img/freq10.png
importance: 2
category: draft
_styles: >
  .post-title {
...
It'll also come in handy for future posts covering more complex ideas.
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/tissue_domain.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 1:</strong> Uniformly distributed points triangulated into a spatial graph to form a simulated tissue domain." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/simulation_lows.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 2:</strong> Schematic for simulating multicellular region patterns and their associated cell types and gene markers." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/simulation_highs.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 3:</strong> Schematic for simulating intercellular interaction patterns and their associated cell types and gene markers." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/frequencies.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 4:</strong> Examples of different frequencies over the tissue domain." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/freq_localization.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/spectra.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 5:</strong> An example gene expression signal in tissue space and in frequency space." %}
...
We'll leave these pitfalls and opportunities to a future post.
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/lowpass_spectra.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 6:</strong> Low-pass filtering of a gene expression signal in frequency space." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/highpass_spectra.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 8:</strong> High-pass filtering of a gene expression signal in frequency space." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/tissue_domain_mop.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 10:</strong> A tissue domain calculated from real mouse brain data." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/frequencies_mop.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 11:</strong> Example frequencies over the mouse brain tissue domain." %}
...
{% include figure.liquid loading="eager" path="assets/figures/fourier/spectra_mop.png" class="img-fluid rounded z-depth-1" caption="<strong>Figure 12:</strong> An example gene expression signal in tissue space and in frequency space." %}
