...
(This is literally the same math introduced in a [previous post](/_posts/2025-05-18-graph-fourier.md) except that it relies on an adjacency matrix rather than a Laplacian matrix).
