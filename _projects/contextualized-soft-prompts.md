...
Prepend's shared features are all anomaly and noise detectors. The contextualized soft prompt shares these, but it adds a number of features related not just to tone, but to persona.
